...
### Week 4 Objectives:
* Research theory and practice deploying Relational Databases (Amazon RDS) and Non-relational Databases (Amazon DynamoDB).
* Learn about Serverless architecture through AWS Lambda cloud computing service.
...
* Mastered various administration tools (Console, CLI, SDK) to work flexibly with NoSQL DynamoDB system.
* Initially grasped Serverless system design mindset to optimize operational costs and auto-scalability.
